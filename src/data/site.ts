...
export const SITE = {
  ...
  title: 'Telegram下载 | 电报中文版官网',
  description: 'Telegram（电报）中文版官网提供最新版 Telegram 下载，支持 Windows、Mac、Android、iPhone 和网页版。获取安全稳定的即时通讯体验，享受高速聊天、群组、频道及文件传输功能，一键下载安装最新版 Telegram。',
